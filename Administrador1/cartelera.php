...
<li class="nav-item active">
    ...
    <i class="fa fa-user" aria-hidden = "true"> </i>
     ...
     <div class="container">
        <div class="row">
            <div class="col-lg-12">            
            <button type="button" class="btn btn-warning" data-toggle="modal"><a href="Reporte_cartelera/reporte.php">Generar Reporte</a></button>    
            </div>    
        </div>    
    </div>    
    <br>  
      ...
      <div class="container caja">
          <div class="row">
              ...
              <div class="table-responsive">        
                  <table id="tablacartelera" class="table table-striped table-bordered table-condensed" style="width:100%" >
  ...
  <div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <form id="formcartelera">    
              <div class="modal-body">
                  <div class="row">
                     ...
                     <!-- <input type="text" class="form-control" id="id_pelicula"> -->
                      
                      <select class="custom-select form-control" id="id_pelicula"  required>
                    ...
                    <!--  <input type="text" class="form-control" id="id_sala">-->
                      <select class="custom-select form-control" id="id_sala"  required>
                  ...
                  <div class="row"> 
                     ...
                     <!-- <input type="text" class="form-control" id="id_formato">-->
                      <select class="custom-select form-control" id="id_formato"  required>
                      ...
                      <div class="col-lg-6">
                      <div class="form-group">
                      <label for="" class="col-form-label">Audio</label>
                     <!-- <input type="text" class="form-control" id="id_audio">-->
                      <select class="custom-select form-control" id="id_audio"  required>
                  ...
                  <div class="row"> 
                      <div class="col-lg-6">
                      <div class="form-group">
                      <label for="" class="col-form-label">Hora_inicio</label>
                      <input type="time" class="form-control" id="hora_inicio"  required>
                      </div>               
                      </div>
                      <div class="col-lg-6">
                      <div class="form-group">
                      <label for="" class="col-form-label">Hora_final</label>
    ...
    <script type="text/javascript" src="js/main_cartelera.js"></script> 
