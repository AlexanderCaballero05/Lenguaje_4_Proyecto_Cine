$(document).ready(function() {
    ...
    tablagenero = $('#tablaestado').DataTable({  
        "ajax":{            
            "url": "crud/crudestado.php", 
       ...
       // id = $.trim($('#id').val());    
        ...
        descripcion = $.trim($('#descripcion').val());    
            ...
            $.ajax({
              ...
              type: "POST",
              datatype:"json",    
              data:  {id:id, tipo:tipo, descripcion:descripcion,opcion:opcion},    
    ...
    $(document).on("click", ".btnBorrar", function(){
        ...
        if (respuesta) {            
            $.ajax({
              ...
              success: function() {
                  tablaestado.row(fila.parents('tr')).remove().draw();                  
               }
            });	
        }
     });
