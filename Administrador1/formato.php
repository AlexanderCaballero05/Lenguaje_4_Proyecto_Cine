...
<li class="nav-item active">
      ...
      <div class="container caja">
          <div class="row">
              ...
              <div class="table-responsive">        
                  <table id="tablaformato" class="table table-striped table-bordered table-condensed" style="width:100%" >
  ...
  <div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <script src="dasboard/js/demo/chart-area-demo.js"></script>
    <script src="dasboard/js/demo/chart-pie-demo.js"></script>
    ...
    <script type="text/javascript" src="js/main_formato.js"></script> 
