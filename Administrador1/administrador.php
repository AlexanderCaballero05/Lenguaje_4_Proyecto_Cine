           ...
           <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    ...
                    <h6 class="collapse-header">Tablas:</h6>
                        ...
                        <a class="collapse-item" href="">Clasificación</a>
            ...
            <div class="container caja">
                  <div class="row">
                        ...
                        <div class="table-responsive">        
                          <table id="tablaadmind" class="table table-striped table-bordered table-condensed" style="width:100%" >
...
<div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form id="formclasificacion">    
            <div class="modal-body">
                <div class="row">
                    ...
                    <input type="text" class="form-control" id="segundo_nombre" required>
                    </div>               
                    </div>
                 ...
                 <div class="row">
                    <div class="col-lg-3">
                    <div class="form-group">
                    <label for="" class="col-form-label">apellido2</label>
    ...
    <script type="text/javascript" src="js/main_administrador.js"></script>
