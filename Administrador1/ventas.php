...
<li class="nav-item active">
    ...
    <i class="fa fa-user" aria-hidden = "true"> </i>
        ...
        <div class="row">
            <div class="col-lg-12">            
            <button id="btnNuevo" type="button" class="btn btn-warning" data-toggle="modal"><a href="Reporte_ventas/reporte.php">Generar Reporte</a></button>    
            </div>    
        </div>    
    </div>    
    <br>  
  ...
  <div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <form id="formusuario">    
              <div class="modal-body">
                  <div class="row">
                      ...
                      <label for="" class="col-form-label">Num factura</label>
                      <input type="text" class="form-control" id="id_cartelera"  required>
                      </div> 
                      </div>    
                      <div class="col-lg-5">
                      <div class="form-group">
                      <label for="" class="col-form-label">Nombre 2</label>

                      <input Type="text" class="form-control "  id="can_boleto" required >
    ...
    <script type="text/javascript" src="js/main_ventas.js"></script> 
