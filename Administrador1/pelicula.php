...
<li class="nav-item active">
      ...
      <div class="container caja">
          <div class="row">
              ...
              <div class="table-responsive">        
                  <table id="tablaPELICULA" class="table table-striped table-bordered table-condensed" style="width:100%" >
  ...
  <div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <form id="formpelicula">    
              <div class="modal-body">
                  <div class="row">
                      ...
                      <select class="custom-select form-control" id="NOMBRE" required>
                       </select>
                      </div> 
                      </div>
                  </div>
                  <div class="row"> 
                      ...
                      <select class="custom-select form-control" id="descripcion" required>
                    </select>
                      </div>               
                      </div>
                      <div class="col-lg-6">
                      <div class="form-group">
                      <label for="" class="col-form-label">Sinopsis</label>
                      <textarea type="text" class="form-control" id="signosis" required>
                      </textarea>
                      </div>               
                      </div>
                  ...
                  <div class="row"> 
                      <div class="col-lg-6">
                      <div class="form-group">
                      <label for="" class="col-form-label">duracion</label>
                      ...
                      <select class="custom-select form-control" id="TIPO" required>
                    </select>
                      </div>               
                      </div>
    ...
    <script type="text/javascript" src="js/main_pelicula.js"></script> 
    <script type="text/javascript" src="js/cargardatos_peli.js"></script> 
