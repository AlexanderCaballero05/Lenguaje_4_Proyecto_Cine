          ...
          <form id="formadministrador">    
              <div class="modal-body">
                  <div class="row">
                      ...
                      <label for="" class="col-form-label">Nombre 1</label>
                  ...
                  <div class="row"> 
                      ...
                      <input type="text" min="0"  max="200" class="form-control" id="direccion"  required>
                      </div>               
                      </div>
                </div>
                <div class="row"> 
                ...
                <div class="row">
                      ...
                      <input type="text" min="0"  max="200" class="form-control" id="usuario"  required>
                      </div>               
                      </div>
                ...
                <div class="row">
                      ...
                      <input type="date" min="0"  max="200" class="form-control" id="nacimiento"  required>
                      </div>               
                      </div>            
                 </div>     
