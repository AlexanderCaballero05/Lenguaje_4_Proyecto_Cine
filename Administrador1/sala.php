    ...
    <div class="container caja">
        <div class="row">
            ...
            <div class="table-responsive">        
                <table id="tablasala" class="table table-striped table-bordered table-condensed" style="width:100%" >
...
<div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form id="formsala">    
            <div class="modal-body">
                <div class="row">
                    ...
                    <label for="" class="col-form-label">TIPO SALA</label>
                ...
                <div class="row">   
                    <div class="col-lg-6">    
                        <div class="form-group">
                        <label for="" class="col-form-label">CANTI_ASIENTOS</label>
                        <input type="number" min="10"  max="50" class="form-control" id="canti_asientos" required>
                        </div>            
                    </div>   
                </div>    
    ...
    <script type="text/javascript" src="js/main_sala.js"></script> 
